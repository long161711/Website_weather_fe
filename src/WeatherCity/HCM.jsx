...
import LineChart from "../Components/HCM/LineChart";
import BarChart from "../Components/HCM/BarChart";
...
function HCM() {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:8000/api/forecast_DCM")
      .then((res) => {
  ...
  return (
    <div className="background-homepage">
          ...
          <ul className="menu">
            <li className="has-submenu">
              ...
              <ul className="submenu">
                <li>
                  <Link className="dropdown-item" to="/weather/hanoi">
                    Hà Nội
                  </Link>
                </li>
                <li>
      ...
      <p className="weather-20day-ago">
        THỜI TIẾT THÀNH PHỐ HỒ CHÍ MINH 20 NGÀY QUA
      </p>
