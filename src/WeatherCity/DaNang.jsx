...
import LineChart from "../Components/DaNang/LineChart";
import BarChart from "../Components/DaNang/BarChart";
...
function DaNang() {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:8000/api/forecast_DN")
      .then((res) => {
  ...
  return (
    <div className="background-homepage">
      ...
      <p className="weather-20day-ago">THỜI TIẾT ĐÀ NẴNG 20 NGÀY QUA</p>
